...
const Benefits = () => (
  <div className={styles.benefitsGrid}>
    ...
    <div className={styles.benefitBlock}>
      ...
      <p className={styles.benefitDescription}>
        There's no separate, slower persistence API. Just write changes as they
        happen (yes, every mouse movement). Reflect stores everything
    ...
    <div className={styles.benefitBlock}>
      ...
      <p className={styles.benefitDescription}>
        CRDTs converge, but to what? App-specific validation isn't possible.
        Reflect uses <Link href="#">server reconciliation</Link> instead, a more
        powerful and intuitive technique pioneered by multiplayer games.
      </p>
    </div>
    ...
    <div className={styles.benefitBlock}>
      ...
      <p className={styles.benefitDescription}>
        ...
        on the client. Reflect's use of client storage is “cache-first”, so it
        transits online, offline, or flaky connections seamlessly.
      </p>
    </div>
    ...
    <div className={styles.benefitBlock}>
      ...
      <p className={styles.benefitDescription}>
        Reflect data is just JSON. It's easy to integrate with any UI framework
