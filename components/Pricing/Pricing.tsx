...
const Pricing = () => (
  <div className={styles.pricingContainer}>
    <p>
    Pricing is not final until stable release, but this is what we're thinking. Questions? <Link href='#'>React out</Link>.
    </p>
    <div className={styles.pricingGrid}>
      ...
      <div className={styles.pricingGridData}>
        <img src='/pricing/pricing-check.svg' className={styles.pricingGridIcon} />
      </div>
      <div className={styles.pricingGridData}>
        <img src='/pricing/pricing-check.svg' className={styles.pricingGridIcon} />
      </div>
