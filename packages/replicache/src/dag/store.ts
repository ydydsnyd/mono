...
export interface GetChunkRange {
  getChunkRange(start: Hash, end: Hash): Promise<Chunk[]>;
}

export interface Read extends GetChunk, MustGetChunk, GetChunkRange, Release {
