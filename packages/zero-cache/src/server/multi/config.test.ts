...
test('zero-cache --help', () => {
  ...
  expect(stripAnsi(logger.info.mock.calls[0][0])).toMatchInlineSnapshot(`
    "
     ...
     --auth-verify-key string                      optional                                                                                                                    
       ZERO_AUTH_VERIFY_KEY env                                                                                                                                                
                                                   The public (or secret) key used to verify JWTs. You can also use a remote JWK set. If you use a remote key set, see jwkUrl. 
                                                                                                                                                                               
     --auth-jwk-url string                         optional                                                                                                                    
       ZERO_AUTH_JWK_URL env                                                                                                                                                   
                                                   The URL of the JWK set used to verify JWTs. If set, this overrides verifyKey.                                               
                                                                                                                                                                               
     --auth-decryption-key string                  optional                                                                                                                    
       ZERO_AUTH_DECRYPTION_KEY env                                                                                                                                            
                                                   Secret key used to decrypt encrypted JWTs if you use encrypted JWTs. The                                                    
                                                   key must be a string in JWK format. If this option is set, decryptionAlgorithm must also be set.                            
                                                   See: https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#json_web_key                                   
                                                                                                                                                                               
     --auth-decryption-algorithm string            optional                                                                                                                    
       ZERO_AUTH_DECRYPTION_ALGORITHM env                                                                                                                                      
                                                   The algorithm used to decrypt encrypted JWTs. This option must be set if a decryption key is provided.                      
