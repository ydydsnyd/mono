  ...
  const cases: Case[] = [
    {
      ...
      url: "http://google.com/?clientGroupID=cg1&baseCookie=1&timestamp=t1&lmid=0",
    ...
    },
    {
      ...
      headers: createHeadersWithValidUserData("u1"),
      expectErrorResponse: "Error: invalid querystring - missing clientGroupID",
      existingClients: new Map(),
      expectedClients: () => new Map(),
      version: 1,
    },
    {
      ...
      url: "http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=1&lmid=0",
      headers: createHeadersWithValidUserData("u1"),
    ...
    },
    {
      ...
      url: "http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=1&ts=xx&lmid=0",
      headers: createHeadersWithValidUserData("u1"),
      expectErrorResponse:
        "Error: invalid querystring parameter ts, url: http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=1&ts=xx&lmid=0, got: xx",
      existingClients: new Map(),
      expectedClients: () => new Map(),
      version: 1,
    },
    ...
    },
    {
      ...
      headers: createHeadersWithValidUserData("u1"),
      expectErrorResponse:
        "Error: invalid querystring parameter lmid, url: http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=1&ts=123&lmid=xx, got: xx",
      existingClients: new Map(),
      expectedClients: () => new Map(),
      version: 1,
    },
    {
      ...
      url: "http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=&ts=42&lmid=0",
      headers: createHeadersWithValidUserData("u1"),
      existingClients: new Map(),
    ...
    },
    {
      ...
      url: "http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=1&ts=42&lmid=0",
      headers: createHeadersWithValidUserData("u1"),
    ...
    },
    {
      ...
      url: "http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=2&ts=42&lmid=0",
      headers: createHeadersWithValidUserData("u1"),
      expectErrorResponse: `Unexpected baseCookie. ${maybeOldClientStateMessage}`,
      existingClients: new Map(),
      expectedClients: () => new Map(),
    ...
    },
    {
      ...
      url: "http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=7&ts=42&lmid=0",
      headers: createHeadersWithValidUserData("u1"),
      existingClients: new Map(),
      expectedClients: (socket) =>
        new Map([freshClient("c1", "u1", "cg1", socket)]),
    ...
    },
    {
      ...
      url: "http://google.com/?clientID=c1&clientGroupID=cg1&baseCookie=7&ts=42&lmid=100",
      existingClients: new Map(),
      expectedClients: (socket) =>
        new Map([freshClient("c1", "u1", "cg1", socket)]),
      headers: createHeadersWithValidUserData("u1"),
