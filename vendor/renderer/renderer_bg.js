...
import * as wasm from './renderer_bg.wasm';
...
export function __wbg_static_accessor_MAX_RENDERED_PHYSICS_STEPS_1227ae48b3a9f731() {
    const ret = MAX_RENDERED_PHYSICS_STEPS;
    return ret;
};

export function __wbg_static_accessor_SPLATTER_ANIM_FRAMES_659fe1818af3aa5a() {
    const ret = SPLATTER_ANIM_FRAMES;
    return ret;
};

export function __wbg_static_accessor_UVMAP_SIZE_a2041fefcbe5a985() {
